...
class BookingModel {
  ...
  String get formattedRequiredDate {
  ...
  String get formattedReleaseTime {
    return DateFormat.jm().format(releaseDate);
  }

  String get formattedReportTime {
    return DateFormat.jm().format(requiredDate);
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'release': release,
      'destination': destination,
      'car_reporting_datetime': requiredDate,
      'car_required_till_datetime': releaseDate,
      'purpose': purpose,
      'carType': carType,
      'costOfCar': costOfCar,
      'noOfCars': noOfCars,
      'location_type': locationOfTravel,
      'noOfPerson': noOfPerson,
      'userContactNo': userContactNo,
      'status': status.name
    };
