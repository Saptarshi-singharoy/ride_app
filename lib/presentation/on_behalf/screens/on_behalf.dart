...
import 'package:ride_app/data/dummies/dummy_onbehalf_data.dart';
import 'package:ride_app/data/models/booking.model.dart';
import 'package:ride_app/data/models/on_behalf.model.dart';
...
import 'package:ride_app/presentation/on_behalf/screens/traveler_details.dart';
import 'package:ride_app/utils/themes/themes.dart';
// import 'package:ride_app/src/widgets/bottomsheet/booked_onbehaf_card.dart';

class OnBehalf extends ConsumerStatefulWidget {
  const OnBehalf({super.key, required this.behalfMode});

  final bool behalfMode;

  @override
  ConsumerState<OnBehalf> createState() => _OnBehalfState();
}

class _OnBehalfState extends ConsumerState<OnBehalf> {
